...
@section('title_page', trans('portfolio.show_portfolio'))
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3 mb-2">
                                    <input type="test" value="{{ old('title', request()->input('title')) }}"
                                        name="title" placeholder="{{ trans('admin.title') }}" class="form-control">
                                </div>
                                <div class="col-md-3 mb-2">
                                    <select class="form-select form-select-sm select2" name="tag_id">
                                        ...
                                        @foreach ($tags as $tag)
                                            <option value="{{ $tag->id }}"
                                                {{ request()->input('tag_id') == $tag->id ? 'selected' : '' }}>
                                                {{ @$tag->trans->where('locale', $current_lang)->first()->title }} </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-3 mb-2">
                                ...
                                <div class="search-input col-md-2">
                                    <button class="btn btn-primary btn-sm" type="submit"><i class="fas fa-search">
                                        </i></button>
                                    <a class="btn btn-success btn-sm" href="{{ route('admin.portfolio.index') }}"><i
                            ...
                            <table id="main-datatable"
                                ...
                                <tbody>
                                    ...
                                    @foreach (@$items as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    @if ($item->status == 1)
                                                        <a href="{{ route('admin.portfolio.update-status', $item->id) }}"
                                                    ...
                                                    @if ($item->feature == 1)
                                                        <a href="{{ route('admin.portfolio.update-featured', $item->id) }}"
                                                    ...
                                                    <a href="{{ route('admin.portfolio.show', $item->id) }}"
                                        ...
                                        @include('admin.dashboard.portfolio.delete')
                                    @endforeach
