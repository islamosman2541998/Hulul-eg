                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <select class="form-select form-select-sm select2" name="type">
                                                                    <option value="" selected disabled>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input class="form-control" type="text" placeholder="@lang('admin.link'):" id="example-number-input" name="link" value="{{ old('link') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {{-- image ------------------------------------------------------------------------------------- --}}
