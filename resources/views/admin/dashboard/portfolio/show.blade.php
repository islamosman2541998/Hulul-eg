...
@section('title_page', trans('portfolio.edit', ['name' => @$portfolio->trans->where('locale',$current_lang)->first()->title]) )
                                                        ...
                                                        @foreach ($languages as $key => $locale)
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea id="description{{ $key }}" name="{{ $locale }}[description]" disabled> {{ @$portfolio->trans->where('locale',$locale)->first()->description }} </textarea>
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="col-sm-3 col-md-6 mb-3">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <p class="h2 text-primary ">{{ @$portfolio->tag ?@$portfolio->tag->trans->where('locale',$current_lang)->first()->title: "__"  }}</p>
                                                                    </div>
                                                                </div>
                                                                @error('tag_id')
                                                        ...
                                                        <div class="col-12">
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input class="form-control" type="number" id="example-number-input" disabled  name="sort" value="{{ @$portfolio->sort }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 ">
