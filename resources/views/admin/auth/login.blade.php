...
<body>
    ...
    <!-- Begin page -->
    <div class="accountbg" style="background: url('{{ @$adminLoginTheme->background != null ? asset(@$adminLoginTheme->background) : admin_path('images/background.jpg') }}');background-size: cover;background-position: center;"
                                ...
                                <form class="form-horizontal" method="POST" action="{{ route('admin.post-login') }}">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-sm-12 text-center">
                                            <button class="btn btn-primary w-md waves-effect waves-light border-0 hover-cutom"
                                                type="submit" style=" background-color:{{  @$adminLoginTheme->button_color }};"> @lang('admin.login')  </button>
                                        </div>
                                    </div>
                                </form>
